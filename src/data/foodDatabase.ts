...
export const foodDatabase: FoodItem[] = [
  ...
  { id: 'sunflower_seeds', name: 'Sementes de girassol', category: 'fat', caloriesPer100g: 584, proteinPer100g: 20.7, carbsPer100g: 20, fatPer100g: 51.5, unit: 'g', defaultQuantity: 15, isVegetarian: true, isVegan: true, isGlutenFree: true, isLactoseFree: true, mealTypes: ['breakfast', 'lunch', 'snack', 'dinner', 'lunch', 'dinner'], displayInMealTypeSelection: false },
  { id: 'flax_seeds', name: 'Sementes de linhaça', category: 'fat', caloriesPer100g: 534, proteinPer100g: 18.3, carbsPer100g: 28.9, fatPer100g: 42.2, unit: 'g', defaultQuantity: 15, isVegetarian: true, isVegan: true, isGlutenFree: true, isLactoseFree: true, mealTypes: ['breakfast', 'lunch', 'snack', 'dinner', 'lunch', 'dinner'], displayInMealTypeSelection: false },
